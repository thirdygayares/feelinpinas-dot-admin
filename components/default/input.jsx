...
const InputField = (props) => {
    ...
    return (
        <div className="d-flex flex-row p-2 justify-content-center" style={{width: `${props.width ?? "25%"}`, height: `${props.height ?? "4rem"}`}}>
            ...
            <input className={`p-1 py-2 px-2 col-8 border ${inputClass()} w-100 ${props.className}`} type={props.type ?? "text"} placeholder={props.placeholder} onChange={props.onChange} />
            {
