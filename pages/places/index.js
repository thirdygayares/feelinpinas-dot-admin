        ...
        <>
            ...
            <div className="d-flex flex-column w-100 p-4" style={{ overflow: "hidden", height: "100vh" }}>
                ...
                <section className="d-flex flex-column">
                    <span className="fs-3 fw-bold"> LIST OF PLACES </span>
                    ...
                    <div style={{ height: "70vh", overflow: "scroll" }}>
                        {
                            shuffledPlacesData?.map((val, index) => <div key={index} className="position-relative d-flex flex-column justify-content-center w-100 bg-primary" style={{ height: "12vh" }} onClick={() => setModalShow(true)}>
                                ...
                                <img className="position-absolute w-100 h-100" src={`${val.thumbnail}`} style={{ objectFit: "cover", backgroundPosition: "center", backgroundAttachment: "fixed", objectFit: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "100%", zIndex: 0 }} />

                                <div className="position-relative d-flex flex-column justify-content-center px-3" style={{ zIndex: 2, color: "white", fontFamily: "Poppins" }}>
